...
public class ItemCutpurseArmor extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:cutpurse_armorhelmet")
	public static final Item helmet = null;
	@GameRegistry.ObjectHolder("swordsandsandals:cutpurse_armorbody")
	public static final Item body = null;
	@GameRegistry.ObjectHolder("swordsandsandals:cutpurse_armorlegs")
	public static final Item legs = null;
	@GameRegistry.ObjectHolder("swordsandsandals:cutpurse_armorboots")
	public static final Item boots = null;
	public ItemCutpurseArmor(ElementsSwordsandsandalsMod instance) {
		super(instance, 243);
	}

	@Override
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("CUTPURSE_ARMOR", "swordsandsandals:antaresalpha_", 100, new int[]{1, 3, 4, 1}, 9,
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD) {
			...
			public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
				...
				armorModel.bipedHead = new ModelCotpurseHelmTexture().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "swordsandsandals:textures/cutpursehelmtexture.png";
			}
		}.setUnlocalizedName("cutpurse_armorhelmet").setRegistryName("cutpurse_armorhelmet").setCreativeTab(TabSwordsAndSandalsArmors.tab));
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.CHEST) {
			@Override
			@SideOnly(Side.CLIENT)
			public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
				ModelBiped armorModel = new ModelBiped();
				armorModel.bipedBody = new ModelCutpurseCheastplatemodelnowu().Body;
				armorModel.bipedRightArm = new ModelCutpurseCheastplatemodelnowu().RightArm;
                armorModel.bipedLeftArm = new ModelCutpurseCheastplatemodelnowu().LeftArm;
				armorModel.isSneak = living.isSneaking();
				armorModel.isRiding = living.isRiding();
				armorModel.isChild = living.isChild();
				return armorModel;
			...
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "swordsandsandals:textures/cupursechestplate3.png";
			}
		}.setUnlocalizedName("cutpurse_armorbody").setRegistryName("cutpurse_armorbody").setCreativeTab(TabSwordsAndSandalsArmors.tab));
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.LEGS) {
			...
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "swordsandsandals:textures/cutpurselegginstexture.png";
			}
		}.setUnlocalizedName("cutpurse_armorlegs").setRegistryName("cutpurse_armorlegs").setCreativeTab(TabSwordsAndSandalsArmors.tab));
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.FEET) {
			...
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "swordsandsandals:textures/cutpursebootstexture.png";
			}
		}.setUnlocalizedName("cutpurse_armorboots").setRegistryName("cutpurse_armorboots").setCreativeTab(TabSwordsAndSandalsArmors.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("swordsandsandals:cutpurse_armorhelmet", "inventory"));
		ModelLoader.setCustomModelResourceLocation(body, 0, new ModelResourceLocation("swordsandsandals:cutpurse_armorbody", "inventory"));
		ModelLoader.setCustomModelResourceLocation(legs, 0, new ModelResourceLocation("swordsandsandals:cutpurse_armorlegs", "inventory"));
		ModelLoader.setCustomModelResourceLocation(boots, 0, new ModelResourceLocation("swordsandsandals:cutpurse_armorboots", "inventory"));
	}
