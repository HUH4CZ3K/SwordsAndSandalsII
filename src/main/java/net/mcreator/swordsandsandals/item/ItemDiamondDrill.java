...
import net.mcreator.swordsandsandals.procedure.ProcedureDiamondDrillBlockDestroyedWithTool;
...
public class ItemDiamondDrill extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:diamond_drill")
	public static final Item block = null;
	public ItemDiamondDrill(ElementsSwordsandsandalsMod instance) {
		super(instance, 59);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, IBlockState bl, BlockPos pos, EntityLivingBase entity) {
				...
				int z = pos.getZ();
				{
					...
					ProcedureDiamondDrillBlockDestroyedWithTool.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setUnlocalizedName("diamond_drill").setRegistryName("diamond_drill").setCreativeTab(TabSwordsAndSandalsItems.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("swordsandsandals:diamond_drill", "inventory"));
	}
