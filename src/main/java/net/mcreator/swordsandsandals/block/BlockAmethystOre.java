...
import net.mcreator.swordsandsandals.item.ItemAmethyst;
...
public class BlockAmethystOre extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:amethystore")
	public static final Block block = null;
	public BlockAmethystOre(ElementsSwordsandsandalsMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("swordsandsandals:amethystore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemAmethyst.block, (int) (1)));
		}
	}
}
