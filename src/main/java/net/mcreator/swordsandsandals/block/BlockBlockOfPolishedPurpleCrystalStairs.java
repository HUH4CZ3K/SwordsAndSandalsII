...
public class BlockBlockOfPolishedPurpleCrystalStairs extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:block_of_polished_purple_crystal_stairs")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("swordsandsandals:block_of_polished_purple_crystal_stairs_double")
	public static final Block block_slab_double = null;
	public BlockBlockOfPolishedPurpleCrystalStairs(ElementsSwordsandsandalsMod instance) {
		super(instance, 25);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("block_of_polished_purple_crystal_stairs"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("block_of_polished_purple_crystal_stairs_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("swordsandsandals:block_of_polished_purple_crystal_stairs", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GLASS);
			setUnlocalizedName("block_of_polished_purple_crystal_stairs");
