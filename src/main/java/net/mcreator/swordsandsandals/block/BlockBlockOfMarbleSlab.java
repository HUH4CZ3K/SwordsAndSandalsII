...
public class BlockBlockOfMarbleSlab extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:block_of_marble_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("swordsandsandals:block_of_marble_slab_double")
	public static final Block block_slab_double = null;
	public BlockBlockOfMarbleSlab(ElementsSwordsandsandalsMod instance) {
		super(instance, 27);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("block_of_marble_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("block_of_marble_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("swordsandsandals:block_of_marble_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GLASS);
			setUnlocalizedName("block_of_marble_slab");
