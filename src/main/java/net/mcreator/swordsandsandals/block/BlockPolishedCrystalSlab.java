...
public class BlockPolishedCrystalSlab extends ElementsSwordsandsandalsMod.ModElement {
	@GameRegistry.ObjectHolder("swordsandsandals:polished_crystal_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("swordsandsandals:polished_crystal_slab_double")
	public static final Block block_slab_double = null;
	public BlockPolishedCrystalSlab(ElementsSwordsandsandalsMod instance) {
		super(instance, 33);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("polished_crystal_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("polished_crystal_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("swordsandsandals:polished_crystal_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GLASS);
			setUnlocalizedName("polished_crystal_slab");
